...
if (isset($_POST["Common"])) {
	...
	if (isset($_POST["getCartItem"])) {
		...
		if (mysqli_num_rows($query) > 0) {
			...
			?>
				<a style="float:right;" href="cart.php" class="btn btn-warning">Confirm/Edit&nbsp;&nbsp;<span class="glyphicon glyphicon-edit"></span></a>
			<?php
			exit();
		}
	}
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="primespot@business.example.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/myproject/payment_success.php"/>
									...
									<input style="float:right;margin-right:80px;" type="image" name="submit"
										src="imgpaypal.png" alt="PayPal Checkout"
